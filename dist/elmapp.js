...
var author$project$Model$SuccessLogin = function (a) {
	return {$: 'SuccessLogin', a: a};
};
var author$project$Main$subscriptions = function (model) {
	return author$project$Main$loginResult(author$project$Model$SuccessLogin);
};
			...
			case 'SuccessLogin':
				...
				if (_n1) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{activePage: author$project$Model$ShowsPage, activeTab: author$project$Model$LoggedInTab, loginResult: data}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
